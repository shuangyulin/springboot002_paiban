    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="医院简介" prop="yiyuanjianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yiyuanjianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yiyuanjianjie" label="医院简介" prop="yiyuanjianjie">
                    <span v-html="ruleForm.yiyuanjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiyuantupian = true;
          ...
          if(o=='yiyuanjianjie'){
            this.ruleForm.yiyuanjianjie = obj[o];
	    this.ro.yiyuanjianjie = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.yiyuanjianjie = this.ruleForm.yiyuanjianjie.replace(reg,'../../../springbootjf5zc/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

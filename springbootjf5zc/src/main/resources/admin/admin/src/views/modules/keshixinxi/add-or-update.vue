<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科室位置" prop="keshiweizhi">
          <el-input v-model="ruleForm.keshiweizhi" 
              placeholder="科室位置" clearable  :readonly="ro.keshiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科室位置" prop="keshiweizhi">
              <el-input v-model="ruleForm.keshiweizhi" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="科室医生" prop="keshiyisheng">
          <el-select v-model="ruleForm.keshiyisheng" placeholder="请选择科室医生">
            <el-option
                v-for="(item,index) in keshiyishengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="科室医生" prop="keshiyisheng">
	      <el-input v-model="ruleForm.keshiyisheng"
                placeholder="科室医生" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="联系电话" prop="lianxidianhua">
          <el-select v-model="ruleForm.lianxidianhua" placeholder="请选择联系电话">
            <el-option
                v-for="(item,index) in lianxidianhuaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="科室介绍" prop="keshijieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.keshijieshao" label="科室介绍" prop="keshijieshao">
                    <span>{{ruleForm.keshijieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.keshiweizhi = true;
          ...
          if(o=='keshiyisheng'){
            this.ruleForm.keshiyisheng = obj[o];
	    this.ro.keshiyisheng = true;
            continue;
          }
          if(o=='lianxidianhua'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/yihu/xingming`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.keshiyishengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              url: `option/yihu/shoujihao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.lianxidianhuaOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
